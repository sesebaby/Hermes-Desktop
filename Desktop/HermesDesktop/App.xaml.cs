...
public partial class App : Application
{
    ...
    private static ServiceProvider ConfigureServices()
    {
        ...
        services.AddSingleton<INpcDeveloperTranscriptReader, SqliteNpcDeveloperTranscriptReader>();
        services.AddSingleton<INpcDeveloperTodoReader, SupervisorNpcDeveloperTodoReader>();
        services.AddSingleton<INpcDeveloperInspectorText, NpcDeveloperInspectorResourceText>();
