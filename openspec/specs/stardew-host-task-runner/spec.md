...
Define the single Stardew v1 host task execution path for model-visible gameplay tools, bridge execution, runtime correlation, terminal facts, idempotency, watchdog behavior, and resource ownership.
